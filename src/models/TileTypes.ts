...
export const TILE_PROPERTIES: Record<TileType, TileProperties> = {
  [TileType.GRASS]:   { type: TileType.GRASS,   friction: 0.88, canPlaceBall: true,  speedMultiplier: 0.8, color: 0x4a8f3f, bounceFactor: 0.35, landingSpeedFactor: 0.20 },
  [TileType.FAIRWAY]: { type: TileType.FAIRWAY,  friction: 0.91, canPlaceBall: true,  speedMultiplier: 1.0, color: 0x5cb85c, bounceFactor: 0.40, landingSpeedFactor: 0.30 },
  [TileType.GREEN]:   { type: TileType.GREEN,    friction: 0.94, canPlaceBall: true,  speedMultiplier: 1.0, color: 0x7dcea0, bounceFactor: 0.45, landingSpeedFactor: 0.35 },
  ...
  [TileType.ROUGH]:   { type: TileType.ROUGH,    friction: 0.82, canPlaceBall: true,  speedMultiplier: 0.6, color: 0x3d7a33, bounceFactor: 0.25, landingSpeedFactor: 0.10 },
  [TileType.TEE]:     { type: TileType.TEE,      friction: 0.91, canPlaceBall: true,  speedMultiplier: 1.0, color: 0x8fbc8f, bounceFactor: 0.40, landingSpeedFactor: 0.30 },
};
